...
SOURCEFILES_QUOTED_IF_SPACED=LCD/busyxlcd.c LCD/openxlcd.c LCD/putrxlcd.c LCD/putsxlcd.c LCD/readaddr.c LCD/readdata.c LCD/setcgram.c LCD/setddram.c LCD/wcmdxlcd.c LCD/writdata.c temp_source.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/LCD/busyxlcd.o ${OBJECTDIR}/LCD/openxlcd.o ${OBJECTDIR}/LCD/putrxlcd.o ${OBJECTDIR}/LCD/putsxlcd.o ${OBJECTDIR}/LCD/readaddr.o ${OBJECTDIR}/LCD/readdata.o ${OBJECTDIR}/LCD/setcgram.o ${OBJECTDIR}/LCD/setddram.o ${OBJECTDIR}/LCD/wcmdxlcd.o ${OBJECTDIR}/LCD/writdata.o ${OBJECTDIR}/temp_source.o
POSSIBLE_DEPFILES=${OBJECTDIR}/LCD/busyxlcd.o.d ${OBJECTDIR}/LCD/openxlcd.o.d ${OBJECTDIR}/LCD/putrxlcd.o.d ${OBJECTDIR}/LCD/putsxlcd.o.d ${OBJECTDIR}/LCD/readaddr.o.d ${OBJECTDIR}/LCD/readdata.o.d ${OBJECTDIR}/LCD/setcgram.o.d ${OBJECTDIR}/LCD/setddram.o.d ${OBJECTDIR}/LCD/wcmdxlcd.o.d ${OBJECTDIR}/LCD/writdata.o.d ${OBJECTDIR}/temp_source.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/LCD/busyxlcd.o ${OBJECTDIR}/LCD/openxlcd.o ${OBJECTDIR}/LCD/putrxlcd.o ${OBJECTDIR}/LCD/putsxlcd.o ${OBJECTDIR}/LCD/readaddr.o ${OBJECTDIR}/LCD/readdata.o ${OBJECTDIR}/LCD/setcgram.o ${OBJECTDIR}/LCD/setddram.o ${OBJECTDIR}/LCD/wcmdxlcd.o ${OBJECTDIR}/LCD/writdata.o ${OBJECTDIR}/temp_source.o

# Source Files
SOURCEFILES=LCD/busyxlcd.c LCD/openxlcd.c LCD/putrxlcd.c LCD/putsxlcd.c LCD/readaddr.c LCD/readdata.c LCD/setcgram.c LCD/setddram.c LCD/wcmdxlcd.c LCD/writdata.c temp_source.c
...
${OBJECTDIR}/temp_source.o: temp_source.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/temp_source.o.d 
	@${RM} ${OBJECTDIR}/temp_source.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1 -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/temp_source.o   temp_source.c 
	@${DEP_GEN} -d ${OBJECTDIR}/temp_source.o 
	@${FIXDEPS} "${OBJECTDIR}/temp_source.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
${OBJECTDIR}/temp_source.o: temp_source.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/temp_source.o.d 
	@${RM} ${OBJECTDIR}/temp_source.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/temp_source.o   temp_source.c 
	@${DEP_GEN} -d ${OBJECTDIR}/temp_source.o 
	@${FIXDEPS} "${OBJECTDIR}/temp_source.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/TemperatureSensor.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    lab1_i.lkr
...
dist/${CND_CONF}/${IMAGE_TYPE}/TemperatureSensor.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   lab1_i.lkr
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_LD} $(MP_EXTRA_LD_PRE) "lab1_i.lkr"  -p$(MP_PROCESSOR_OPTION_LD)  -w  -m"${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"  -z__MPLAB_BUILD=1  -u_CRUNTIME -l ${MP_CC_DIR}\\..\\lib  -o dist/${CND_CONF}/${IMAGE_TYPE}/TemperatureSensor.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}   
endif
